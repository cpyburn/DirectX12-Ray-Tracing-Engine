...
Note: I will not be doing any code reuse methods for the next couple of tutorials. Reason, I think bouncing around lots of methods can lose some people. After refitting tutorial, we will make methods that are reusable.
