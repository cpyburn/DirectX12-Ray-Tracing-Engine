...
namespace CPyburnRTXEngine
{
    ...
    void TestInstances::CreateModelBuffers()
    {
        ...
        m_triangleVertexBuffer = BufferHelpers::CreateBufferOnDefaultHeap<AssimpFactory::VSVertices>(m_deviceResources, m_assimpFactory.GetMeshEntries()[0].vertices, commandList, m_commandAllocator[0], L"Model Buffer");
        m_triangleIndicesBuffer = BufferHelpers::CreateBufferOnDefaultHeap<UINT>(m_deviceResources, m_assimpFactory.GetMeshEntries()[0].indices, commandList, m_commandAllocator[0], L"Index Buffer");
    ...
    void TestInstances::createAccelerationStructures()
    {
        ...
        // Bottom Level AS
        {
            ...
            m_triangleBlas = BufferHelpers::CreateBlas<AssimpFactory::VSVertices>(m_deviceResources, static_cast<UINT>(m_assimpFactory.GetMeshEntries()[0].vertices.size()), m_triangleVertexBuffer, commandList, m_commandAllocator[0], m_triangleIndicesBuffer, static_cast<UINT>(m_assimpFactory.GetMeshEntries()[0].indices.size()));
        }
