...
namespace CPyburnRTXEngine
{
    ...
    void TestInstances::CreateModelBuffers()
    {
        ...
        m_triangleVertexBuffer = BufferHelpers<AssimpFactory::VSVertices>::CreateBufferOnDefaultHeap(m_deviceResources, m_assimpFactory.GetMeshEntries()[0].vertices, commandList, m_commandAllocator[0], L"Model Buffer");
        m_triangleIndicesBuffer = BufferHelpers<UINT>::CreateBufferOnDefaultHeap(m_deviceResources, m_assimpFactory.GetMeshEntries()[0].indices, commandList, m_commandAllocator[0], L"Index Buffer");
